...
const ReviewContainer = (props: Props) => {
  ...
  const [isFocusedOnComment, setFocusOnComment] = useState(false)
  ...
  return (
    <div className="review-container">
      <div className="content">
        ...
        <p className={`${isFocusedOnComment || postComment ? 'tranistion-hide' : ''} sign-up-message`}>
          {
            !postComment &&
            <React.Fragment>
              You can review products anonymously. But we recommend you to <span className="sign-up-link">sign up</span>.
            </React.Fragment>
          }
        </p>
        {!postComment && (
          <React.Fragment>
            <div className="comment form-group">
              <div className="avatar-input">
                ...
                <textarea
                  onBlur={e => setFocusOnComment(false)}
                  onFocus={e => setFocusOnComment(true)}
              ...
              <div className="raty-button">
                <div className="raty-group">
                  <div className="forget-text">Don't forget to rate.</div>
