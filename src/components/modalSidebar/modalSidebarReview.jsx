...
const ModalSideBarReview = (props: Props) => {
  ...
  return (
    <div className="iphn-lft">
      ...
      <div className="own-radio-container">
        <div className="own_radio" ><span onClick={handleOwnClick} ><input type="radio" value={own} checked={own} /><label>I Own This Device</label></span></div>
      </div>
